...
#' @return An object of class "msfit". See \code{\link{msfit}} for details.
...
#'  
#' @author Rui Costa, adapting the work of Hein Putter in the package
#' \code{mstate}.
#' @seealso \code{\link{msfit}}; \code{\link{msprep}}; \code{\link{plot.msfit}}.
#' @references 
